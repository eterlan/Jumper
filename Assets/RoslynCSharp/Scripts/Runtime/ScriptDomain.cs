    ...
    public class ScriptDomain : IDisposable
    {
        ...
        public ScriptAssembly CompileAndLoadSource(string cSharpSource, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings, IMetadataReferenceProvider[] additionalReferenceAssemblies = null)
        {
            ...
            lock(this)
            {
                ...
                // Security check
                return RegisterAssembly<ScriptCompiledAssemblyImpl>(compileResult.OutputAssembly, securityMode, CompileResult);
        ...
        public ScriptAssembly RegisterAssembly<T>(Assembly systemAssembly, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings, CompilationResult compileResult = null) where T : ScriptAssembly, new()
        {
            ...
            return RegisterAssemblyImpl(ScriptAssembly.CreateScriptAssembly<T>(this, systemAssembly, null, null, compileResult), securityMode);
        }

        public ScriptAssembly RegisterAssemblyPath(Assembly systemAssembly, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings, string assemblyPath = null, CompilationResult compileResult = null)
        {
            return RegisterAssemblyPath<ScriptAssemblyImpl>(systemAssembly, securityMode, assemblyPath, compileResult);
        }

        public ScriptAssembly RegisterAssemblyPath<T>(Assembly systemAssembly, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings, string assemblyPath = null, CompilationResult compileResult = null) where T : ScriptAssembly, new()
        {
            // Check for null assembly
            if (systemAssembly == null)
                return null;

            return RegisterAssemblyImpl(ScriptAssembly.CreateScriptAssembly<T>(this, systemAssembly, assemblyPath, null, compileResult), securityMode);
        }

        public ScriptAssembly RegisterAssemblyImage(Assembly systemAssembly, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings, byte[] assemblyImage = null, CompilationResult compileResult = null)
        {
            return RegisterAssemblyImage<ScriptAssemblyImpl>(systemAssembly, securityMode, assemblyImage, compileResult);
        }

        public ScriptAssembly RegisterAssemblyImage<T>(Assembly systemAssembly, ScriptSecurityMode securityMode = ScriptSecurityMode.UseSettings, byte[] assemblyImage = null, CompilationResult compileResult = null) where T : ScriptAssembly, new()
        {
            // Check for null assembly
            if (systemAssembly == null)
                return null;

            return RegisterAssemblyImpl(ScriptAssembly.CreateScriptAssembly<T>(this, systemAssembly, null, assemblyImage, compileResult), securityMode);
        }
