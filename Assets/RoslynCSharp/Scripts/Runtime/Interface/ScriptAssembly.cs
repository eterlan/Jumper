...
namespace RoslynCSharp
{
    ...
    public abstract class ScriptAssembly : IMetadataReferenceProvider
    {
        ...
        /// </summary>
        public virtual MetadataReference Reference
        {
            get
            {
        ...
        protected virtual CodeSecurityEngine CreateSecurityEngine()
        {
            if(AssemblyImage != null)
            {
                return new CodeSecurityEngine(AssemblyImage);
            }
        ...
        public static T CreateScriptAssembly<T>(ScriptDomain domain, Assembly systemAssembly, string assemblyPath = null, byte[] assemblyImage = null, CompilationResult compileResult = null) where T : ScriptAssembly, new()
        {
            T assembly = new T();
