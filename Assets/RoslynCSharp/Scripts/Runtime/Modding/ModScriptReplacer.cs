...
namespace RoslynCSharp.Modding
{
    ...
    public static class ModScriptReplacer
    {
        ...
        // Public
        /// <summary>
        /// What should happen when an external script will replace an internal game script.
        /// </summary>
        //public static ScriptReplacementBehaviour scriptReplaceBehaviour = ScriptReplacementBehaviour.DestroyOriginal;

        /// <summary>
        /// Should the public or serializable fields of the orignal script be copied onto the new replacement script.
        /// The replamcment script should define the same serialized fields if this option is enabled, otherwise there may be warnings reported into the <see cref="ModScriptReplacerReport"/>.
        /// Incompattible typed fields or missing fields will simply be skipped with a warning generated in the report.
        /// </summary>
        //public static bool copySerializedFieldsOnReplacement = true;
